...
public final class ConnectorEventPublicationException extends RuntimeException {

  private final String failureCode;
  private final boolean retryable;

  public ConnectorEventPublicationException(
      String failureCode, boolean retryable, Throwable cause) {
    super("Connector integration event publication failed", cause);
