...
/** Connector-owned contract for one normalized customer page sent downstream. */
public record BusinessPartnerImportPage(
    UUID tenantId,
    UUID sourceSystemId,
    UUID importRunId,
    UUID pageAcceptanceId,
    List<SourceCustomerRecord> records) {

  public BusinessPartnerImportPage {
