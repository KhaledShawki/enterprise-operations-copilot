...
public final class ConnectorNotActiveException extends RuntimeException {

  public ConnectorNotActiveException(
  ...
  private static String message(
    ...
    return "Connector %s for tenant %s cannot be suspended while its status is %s"
