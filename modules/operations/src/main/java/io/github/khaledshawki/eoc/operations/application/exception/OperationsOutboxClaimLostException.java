...
public final class OperationsOutboxClaimLostException extends RuntimeException {

  private final UUID eventId;
  private final String claimOwner;
  private final int publicationAttempt;

  public OperationsOutboxClaimLostException(
      UUID eventId, String claimOwner, int publicationAttempt) {
    super("Operations outbox event is no longer owned by the requesting publication claim");
