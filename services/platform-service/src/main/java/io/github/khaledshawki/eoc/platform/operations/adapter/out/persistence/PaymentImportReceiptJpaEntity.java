...
@Entity
@Table(name = "operations_payment_import_receipts")
@IdClass(PaymentImportReceiptJpaId.class)
class PaymentImportReceiptJpaEntity {
  ...
  @Column(
      ...
      nullable = false,
      updatable = false,
      length = PaymentImportReceipt.SHA_256_HEX_LENGTH)
  ...
  protected PaymentImportReceiptJpaEntity() {}

  PaymentImportReceiptJpaEntity(
      UUID tenantId,
      UUID sourceSystemId,
      UUID importBatchId,
      ...
      long staleCount,
      Instant acceptedAt) {
    this.tenantId = Objects.requireNonNull(tenantId, "Payment receipt tenant id cannot be null");
    this.sourceSystemId =
    ...
    this.payloadFingerprint =
        Objects.requireNonNull(payloadFingerprint, "Payment receipt fingerprint cannot be null");
