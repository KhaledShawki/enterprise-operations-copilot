...
@Entity
@Table(name = "operations_invoice_source_mappings")
@IdClass(InvoiceSourceMappingJpaId.class)
class InvoiceSourceMappingJpaEntity {
  ...
  protected InvoiceSourceMappingJpaEntity() {}

  InvoiceSourceMappingJpaEntity(
      UUID tenantId,
      UUID sourceSystemId,
    ...
    this.payloadFingerprint =
        Objects.requireNonNull(
            payloadFingerprint, "Invoice source mapping fingerprint cannot be null");
