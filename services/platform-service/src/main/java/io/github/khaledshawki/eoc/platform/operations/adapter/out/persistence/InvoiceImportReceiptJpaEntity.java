...
@Entity
@Table(name = "operations_invoice_import_receipts")
@IdClass(InvoiceImportReceiptJpaId.class)
class InvoiceImportReceiptJpaEntity {
  ...
  @Column(
      ...
      nullable = false,
      updatable = false,
      length = InvoiceImportReceipt.SHA_256_HEX_LENGTH)
  ...
  protected InvoiceImportReceiptJpaEntity() {}

  InvoiceImportReceiptJpaEntity(
      UUID tenantId,
      UUID sourceSystemId,
      UUID importBatchId,
      ...
      long staleCount,
      Instant acceptedAt) {
    this.tenantId = Objects.requireNonNull(tenantId, "Invoice receipt tenant id cannot be null");
    this.sourceSystemId =
    ...
    this.payloadFingerprint =
        Objects.requireNonNull(payloadFingerprint, "Invoice receipt fingerprint cannot be null");
